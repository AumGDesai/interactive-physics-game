...
def collision_balloon_block(balloon, block, dt):
    ...
    bblock.setPosition(balloon.getPosition()[0], balloon.getPosition()[
        1] + balloon.getSize() * balloon.getScale() + +balloon.getSize() * balloon.getScale() * 7)
    ball = Ball(balloon.getWin(), balloon.getSize() * balloon.getScale(), balloon.getPosition()[0],
                balloon.getPosition()[1] - balloon.getSize() * balloon.getScale())
